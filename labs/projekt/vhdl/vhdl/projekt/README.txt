...
![Enable](../nový priečonok/vhdl/projekt/enable.png)
...
Obecne poznamky:
Testbench je vytvoren pro system stmivani (fader_testb). Bohuzel jsem nestihl nasimulovat enkoder a casovac - je napsany, ale neotestovany.
